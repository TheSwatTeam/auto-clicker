...
for i in range (200): #// the number is how many times this program to click. you can make it infinite by making it like 9999 or something.
	pyautogui.leftClick() #// You can enter co-ordinates in the brackets if you want to get a precise location for where it clicks

#// Ik this is not fast as fuck but it's meant to be used on minecraft servers so it's not detectable. This also works on roblox.
